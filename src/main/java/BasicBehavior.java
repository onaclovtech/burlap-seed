...
protected int [][] map = new int[][]{
	...
	public BasicBehavior(){
        ...
        rf.setReward(3,2,1.0);
        rf.setReward(3,1,-1.0);
        tf = new GridWorldTerminalFunction();
        tf.markAsTerminalPosition(3,2);
		...
		GridWorldDomain.setLocation(initialState, 0, 3,2);
...
public static class ExampleTF implements TerminalFunction{
	...
	public void policyIterationExample(String outputPath){
		...
		Planner planner = new PolicyIteration(domain, rf, tf, 0.99, hashingFactory, 0.001, 1000, 2000);
		Policy p = planner.planFromState(initialState);
